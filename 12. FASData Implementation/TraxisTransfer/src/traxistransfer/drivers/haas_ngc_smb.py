"""Haas NGC SMB driver — stub for future implementation."""
...
class HaasNgcSmbDriver(TransferDriver):
    """SMB-based transfer for Haas NGC controls (not yet implemented)."""
    ...
    def send_program(self, file_path: Path, program_number: str | None = None,
        ...
        raise NotImplementedError("Haas NGC SMB driver not yet implemented")
